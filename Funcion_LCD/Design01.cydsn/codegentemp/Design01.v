...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0d72256f-39d0-4848-a85f-4390bd628fd1/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Linterna_net;
	wire [0:0] tmpFB_0__Linterna_net;
	wire [0:0] tmpIO_0__Linterna_net;
	wire [0:0] tmpINTERRUPT_0__Linterna_net;
	electrical [0:0] tmpSIOVREF__Linterna_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Linterna
		 (.oe(tmpOE__Linterna_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Linterna_net[0:0]}),
		  .io({tmpIO_0__Linterna_net[0:0]}),
		  .siovref(tmpSIOVREF__Linterna_net),
		  .interrupt({tmpINTERRUPT_0__Linterna_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Linterna_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("edc0d748-5d63-497d-9819-29f026e7de53"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("dbca3587-a97a-4088-817b-63eaa4157eae"),
		  .source_clock_id(""),
		  .divisor(0),
