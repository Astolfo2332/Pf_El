...
# Date: Sat, 03 Jun 2023 02:36:15 GMT
#set_units -time ns
create_clock -name {LED_Driver_ClkInternal(routed)} -period 1000000 -waveform {0 500000} [list [get_pins {ClockBlock/dclk_2}]]
...
create_generated_clock -name {LED_Driver_ClkInternal} -source [get_pins {ClockBlock/clk_sync}] -edges {1 24001 48001} [list [get_pins {ClockBlock/dclk_glb_2}]]
...
# Project: D:\Documentos\Universidad\OneDrive - Universidad de Antioquia\Trabajos u 2023-1\Bioinstrumentacion\Labs\Pf\Pf\Desing_pf.cydsn\Desing_pf.cyprj
# Date: Sat, 03 Jun 2023 02:36:12 GMT
