...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("62d8b2b5-d7f1-41bb-a41d-2d5f6cd1dbf3/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("5557acb4-db0d-4369-8481-ef1ff76e4906"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__disminuir_net;
	wire [0:0] tmpIO_0__disminuir_net;
	wire [0:0] tmpINTERRUPT_0__disminuir_net;
	electrical [0:0] tmpSIOVREF__disminuir_net;

	cy_psoc3_pins_v1_10
		#(.id("b3f30cbf-f61c-497d-9426-e58ff60cdea5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		disminuir
		 (.oe(tmpOE__disminuir_net),
		  .y({1'b0}),
		  .fb({Net_7}),
		  .io({tmpIO_0__disminuir_net[0:0]}),
		  .siovref(tmpSIOVREF__disminuir_net),
		  .interrupt({tmpINTERRUPT_0__disminuir_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__disminuir_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("2136b12b-af3d-4ac5-a818-da8d1f3d224d"),
		  .source_clock_id(""),
		  .divisor(0),
